...
cycle15_16 <- cycle_impmerge_fun("DEMO_I", "UCPREG_I", "SXQ_I", "RHQ_I", "HSQ_I",
                                   "HIV_I", TRUE, "CHLMDA_I", "HSV_I", "TRICH_I",numeric_vars = c("DMDHHSIZ","DMDFMSIZ", "DMDHHSZA", "HSQ580", "DMDHHSZB", "DMDHHSZE", "RHQ602Q"))

cycle13_14 <- cycle_impmerge_fun("DEMO_H", "UCPREG_H", "SXQ_H", "RHQ_H", "HSQ_H",
                                 "HIV_H", TRUE, "CHLMDA_H", "HSV_H", "TRICH_H", numeric_vars = c("DMDHHSIZ","DMDFMSIZ", "DMDHHSZA", "HSQ580", "DMDHHSZB", "DMDHHSZE"))
#
...
# cycle15_16 <- cycle_impmerge_fun("DEMO_I.xpt", "UCPREG_I.xpt", "SXQ_I.xpt", "RHQ_I.xpt", "HSQ_I.xpt",
#                                    "HIV_I.xpt", TRUE, "CHLMDA_I.xpt", "HSV_I.xpt", "TRICH_I.xpt")
# 
# cycle13_14 <- cycle_impmerge_fun("DEMO_H.xpt", "UCPREG_H.xpt", "SXQ_H.xpt", "RHQ_H.xpt", "HSQ_H.xpt",
#                                  "HIV_H.xpt", TRUE, "CHLMDA_H.xpt", "HSV_H.xpt", "TRICH_H.xpt")
# # 
# cycle11_12 <- cycle_impmerge_fun("DEMO_G.xpt", "UCPREG_G.xpt", "SXQ_G.xpt", "RHQ_G.xpt", "HSQ_G.xpt",
#                                  "HIV_G.xpt", TRUE, "CHLMDA_G.xpt", "HSV_G.xpt", "HEPB_S_G.xpt") # n.b. no trich, replaced with hep-B
# 
# cycle09_10 <- cycle_impmerge_fun("DEMO_F.xpt", "UCPREG_F.xpt", "SXQ_F.xpt", "RHQ_F.xpt", "HSQ_F.xpt",
#                                  "HIV_F.xpt", TRUE, "CHLMDA_F.xpt", "HSV_F.xpt", "HEPB_S_F.xpt") # n.b. no trich, replaced with hep-B

# cycle07_08 <- cycle_data_impmerge_fun("DEMO_E.xpt", "UCPREG_E.xpt", "SXQ_E.xpt", "RHQ_E.xpt", "HSQ_E.xpt",
#                                  "HIV_E.xpt", TRUE, "CHLMDA_E.xpt", "HSV_E.xpt", "HEPB_S_E.xpt") # n.b. no trich, replaced with hep-B
...
#male sex partners in teh past year (2007-2008)
# nhns$year_msm[nhns$SXQ450 > 0 &  nhns$SXQ450 < 7777 ] <- 1
# nhns$year_msm[nhns$SXQ450 == 0] <- 0

# how many men have you had oral or anal sex with
...
nhns$lifetime_aioral_msm[nhns$SXQ410 > 0 & nhns$SXQ410 < 7777] <- 1
nhns$lifetime_aioral_msm[nhns$SXQ410 == 0] <- 0

# In your lifetime, with how many men have you had anal sex?
# In your lifetime, with how many men have you had anal sex?
nhns$lifetime_ai_msm[nhns$SXQ836 > 0 & nhns$SXQ836 < 7777] <- 1
nhns$lifetime_ai_msm[nhns$SXQ836 == 0] <- 0
...
nhns$yr_f_1vi[nhns$SXQ727 > 0 & nhns$SXQ727 < 7777 ] <- 1
nhns$yr_f_1vi[nhns$SXQ727 < 1] <- 0

nhns$yr_f_sum_vi<- nhns$SXQ727
nhns$yr_f_sum_vi[nhns$SXQ727 > 7777] <- NA

# In the past 12 months, with how many women have you had vaginal sex? Vaginal sex means your penis in a woman's vagina.
nhns$yr_m_vi[nhns$SXQ827 > 1 & nhns$SXQ827 < 7777] <- 1
nhns$yr_m_vi[nhns$SXQ827 < 2] <- 0

nhns$yr_m_1vi[nhns$SXQ827 > 0 & nhns$SXQ827 < 7777] <- 1
nhns$yr_m_1vi[nhns$SXQ827 < 1] <- 0

nhns$yr_m_sum_vi<- nhns$SXQ827
nhns$yr_m_sum_vi[nhns$SXQ827 > 7777] <- NA
...
nhns$yr_msm_1ai[nhns$SXQ841 > 0 &  nhns$SXQ550 < 7777] <- 1
nhns$yr_msm_1ai[nhns$SXQ841 < 1 ] <- 0

nhns$yr_msm_sum_ai<- nhns$SXQ841
nhns$yr_msm_sum_ai[nhns$SXQ841 > 7777] <- NA
...
nhns$sum_ai_vi[nhns$sum_ai_vi  > 7777] <- NA
...
nhns$prep_msm[nhns$year_msm ==1 & nhns$hiv ==0  & nhns$yr_msm_ai ==1  & (nhns$condom==0 | nhns$dgcct==1) ] <- 1

nhns$prep_msm2[nhns$year_msm ==1 & nhns$hiv ==0 ] <- 0
nhns$prep_msm2[nhns$year_msm ==1 & nhns$hiv ==0  & nhns$yr_msm_1ai ==1 & (nhns$condom==0 | nhns$dgcct==1) ] <- 1
...
# more than 1 partner FEM
nhns$prep_fem[nhns$year_fem ==1 & nhns$hiv ==0] <- 0
nhns$prep_fem[nhns$year_fem ==0 & nhns$hiv ==0] <- 0 # this add to the denominator women without sex partner in past year, and the proportion becomes of all women
nhns$prep_fem[nhns$year_fem ==1 & nhns$hiv ==0  & nhns$yr_f_vi ==1 & (nhns$condom==0 | nhns$gcd==1)] <- 1
# at least 1
nhns$prep_fem2[nhns$year_fem ==1 & nhns$hiv ==0] <- 0
nhns$prep_fem2[nhns$year_fem ==0 & nhns$hiv ==0] <- 0 
nhns$prep_fem2[nhns$year_fem ==1 & nhns$hiv ==0  & nhns$yr_f_1vi ==1 & (nhns$condom==0 | nhns$gcd==1)] <- 1
...
# more than 1 partner MSW
nhns$prep_msw[nhns$year_msw ==1 & nhns$hiv ==0] <- 0
nhns$prep_msw[nhns$year_msw ==0 & nhns$hiv ==0] <- 0
nhns$prep_msw[nhns$year_msw ==1 & nhns$hiv ==0  & nhns$yr_m_vi ==1 & (nhns$condom==0 | nhns$gcd==1)] <- 1

# at least 1 partner MSW
nhns$prep_msw2[nhns$year_msw ==1 & nhns$hiv ==0] <- 0
nhns$prep_msw2[nhns$year_msw ==0 & nhns$hiv ==0] <- 0
nhns$prep_msw2[nhns$year_msw ==1 & nhns$hiv ==0  & nhns$yr_m_1vi ==1 & (nhns$condom==0 | nhns$gcd==1)] <- 1
